    ...
    <div class="tw-flex tw-justify-between tw-w-full">
        ...
        <div class="tw-w-4/12 tw-pl-8">
            ...
            <form action="{{ URL::to('/cart') }}" method="POST">
                ...
                {{-- Chọn số lượng --}}
                  <div class="custom-number-input tw-h-10 tw-w-32 tw-pb-24 tw-justify-between">
                    <label for="custom-input-number" class="tw-w-full tw-text-black tw-text-sm tw-font-semibold">Số lượng:
                    </label>
                    <div class="tw-flex tw-flex-row tw-h-10 tw-w-full tw-rounded-lg tw-relative tw-bg-transparent tw-mt-1">
                        <button data-action="decrement" type="button" class=" tw-bg-gray-50 tw-text-black hover:tw-text-gray-700 hover:tw-bg-gray-100 tw-h-full tw-w-20 tw-rounded-l tw-cursor-pointer tw-outline-none">
                            <span class="tw-m-auto tw-text-2xl tw-font-thin">−</span>
                        </button>
                        <input type="number" class="focus:tw-outline-none tw-text-center tw-w-full tw-bg-gray-50 tw-font-semibold tw-text-md hover:tw-text-black focus:tw-text-black  md:tw-text-basecursor-default tw-flex tw-items-center tw-text-black  tw-outline-none" name="amount" value="1">
                        <button data-action="increment" type="button" class="tw-bg-gray-50 tw-text-black hover:tw-text-gray-700 hover:tw-bg-gray-100 tw-h-full tw-w-20 tw-rounded-r tw-cursor-pointer">
                        <span class="tw-m-auto tw-text-2xl tw-font-thin">+</span>
                    </button>
                  </div>
                </div>
