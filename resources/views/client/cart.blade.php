                    ...
                    echo '<div class="tw-pb-5">
                            <div class=" tw-flex tw-flex-row tw-bg-gray-200">
                                <div class="tw-w-1/4 tw-p-5">
                                    <img src="img/anh_giay_nam/male_shoes('.$i.').jpg" alt="" class="tw-border tw-border-black tw-object-contain">
                                </div>
                                <div class="tw-w-3/4 tw-px-10 tw-py-5">
                                    <div class="tw-flex tw-flex-row tw-justify-between">
                                        <ul>
                                            ...
                                            <li class="tw-pb-2 tw-text-sm opacity-50">Color White</li>
                                            <li class="tw-pb-2 tw-text-sm opacity-50">Size 41</li>
